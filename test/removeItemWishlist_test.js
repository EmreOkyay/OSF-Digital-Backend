...
app.use('/wishlist/removeItem', wishlist);

describe("DELETE /wishlist/removeItem", () => {
	it('Should remove item from the wishlist properly', function (done) {
		request(app)
			.delete(`/${base_url}/wishlist/removeItem`)
